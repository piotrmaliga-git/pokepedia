<template>
  <section class="bg-gray-50 dark:bg-gray-900">
    <div
      class="mx-auto flex h-screen w-screen flex-col items-center justify-center px-6 py-8 lg:py-0">
      <a
        href="#"
              ...
              <div class="flex items-start">
                <div class="flex h-5 items-center">
                  <input
                    ...
                    type="checkbox"
                    class="h-4 w-4 rounded border border-gray-300 bg-gray-50 focus:ring-blue-300 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600"
                    required="true" />
                </div>
