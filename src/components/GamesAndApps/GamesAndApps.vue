<template>
  <section id="gamesAndApps">
    <div class="items-center max-w-screen-xl gap-16 px-4 py-8 mx-auto lg:grid lg:grid-cols-2">
      <div class="font-light text-gray-500 dark:text-gray-400 sm:text-lg">
        <GamesAndAppsTabs />
      </div>
      <div>
        <iframe
          class="w-full h-64 mx-auto mt-16 rounded-lg shadow-xl sm:h-96 lg:mt-0 lg:max-w-xl"
