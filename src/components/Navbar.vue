      ...
      <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        ...
        <div class="flex items-center md:order-2">
          <button
            ...
            class="inline-flex cursor-pointer items-center justify-center rounded-lg px-4 py-2 text-sm font-medium text-white hover:bg-red-800">
            <svg
        ...
        <div
          ...
          <ul
            ...
            <li>
              <a
                href="#"
                class="block py-2 pl-3 pr-48 text-white hover:text-red-800 md:p-0"
                aria-current="page"
                >Home</a
              >
            </li>
