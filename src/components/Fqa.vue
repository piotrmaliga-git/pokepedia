<template>
  <section class="bg-gray-100">
    <div class="mx-auto max-w-screen-md py-8 px-4 lg:py-16">
      <h2 class="mb-8 text-center text-4xl font-extrabold tracking-tight text-gray-900 lg:mb-16">
      ...
      <div
        ...
        <h2 id="accordion-collapse-heading-1">
          <button
            type="button"
            class="flex w-full items-center justify-between rounded-md border-b border-gray-200 p-5 text-left font-medium text-gray-500 hover:bg-gray-200 focus:text-black"
        ...
        <div
          ...
          <div class="border border-t-0 border-gray-200 p-5">
            <p class="mb-2 text-gray-500">
