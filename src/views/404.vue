  ...
  <section class="bg-white">
    <div
      ...
      <div class="mx-auto max-w-screen-sm text-center">
        ...
        <a
          href="/"
          class="my-4 inline-flex rounded-lg bg-red-800 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-900 focus:outline-none focus:ring-4 focus:ring-red-300"
          >Back to Homepage</a
        >
      </div>
    </div>
